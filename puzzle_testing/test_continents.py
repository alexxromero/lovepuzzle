...
continents are there" and average the per-number probabilities across them.
...
CLUES = [
    ...
    "Count the number of continents on the planet.",
    "How many continents exist?",
]
DETAIL_CSV = "test_continents_results.csv"
SUMMARY_CSV = "test_continents_avg_results.csv"
MAX_NEW_TOKENS = 16
